...
if ('github_document' == rmarkdown::all_output_formats(knitr::current_input()) && !knitr:::is_html_output()) 
   cat('For more information visit the web page [https://moviedo5.github.io/esios2fda-site/](https://moviedo5.github.io/esios2fda-site/) of the package.')
```
...
```{r example-lfdata, eval=FALSE, include=FALSE}
...
plot(out1,
     ylim = c(1.3e5, 4e5),
     ylab = "Demand (MWh)"
     # main = "Forecasted vs. Scheduled Demand\nIberian Blackout April 25-28 2025"
)
...
```{r fig:blackout, echo=FALSE, out.width='100%', fig.cap="Forecasted vs. Scheduled Demand — Iberian Blackout April 25-28 2025"}
knitr::include_graphics("docs/figures/apagon2025.png")
```
